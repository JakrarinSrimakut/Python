...
SECRET_KEY = 'u#i19w58imz34%)v254s+e*67&x_4dg9#5pc_2mfipslv)x(a6'
...
# Static files will be found at djangonautic/assets where BASE_DIR=djangonautic
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'assets'),
)

MEDIA_URL = '/media/' # Location to find media
